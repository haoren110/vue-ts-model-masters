...
// vant 组件
import { Row, Col,Cell, CellGroup,Field,Grid, GridItem,Button, Uploader, Toast,DropdownMenu, DropdownItem, Dialog, Icon, Step, Steps, Tabbar, TabbarItem, Progress, Collapse, CollapseItem, RadioGroup, Radio, Popup, Checkbox, CheckboxGroup, Tag, TreeSelect,List,Area,Search,Picker,DatetimePicker,SwipeCell,Stepper,Panel,Tab,Tabs, NavBar} from 'vant';
